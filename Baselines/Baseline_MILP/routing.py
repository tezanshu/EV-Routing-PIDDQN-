...
class MILPSolverAgent:
    """
    Deterministic global optimum routing using mixed-integer logic (simulated via strict energy-cost shortest path).
    """
